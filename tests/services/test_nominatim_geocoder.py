...
def test_geocode_sync_returns_point(monkeypatch: pytest.MonkeyPatch) -> None:
...
def test_geocode_sync_none_location(monkeypatch: pytest.MonkeyPatch) -> None:
...
def test_geocode_sync_too_coarse(monkeypatch: pytest.MonkeyPatch) -> None:
...
def test_geocode_sync_service_error(monkeypatch: pytest.MonkeyPatch) -> None:
